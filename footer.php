...
// $sSql = "Update ".MS_LANGUAGES_TABLE." set About_Text = 'jjjjj'";

 $sSql = "SELECT About_Text FROM ".MS_LANGUAGES_TABLE."
         WHERE Language_Code = '".$gsLanguage."'";              
  $rs = $UserTableConn->Execute($sSql);

// Stock Inventory Management, version 1.0

// Managing your stock inventory so easily...




// Web Developer:
// Masino Sinaga (masino.sinaga@gmail.com)
// Website: http://www.ilovephpmaker.com
